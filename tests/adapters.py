...
def run_multihead_self_attention(
    ...
    """
    attention = MultiHeadSelfAttention(d_model, num_heads, 0, 0.0)
    attention.load_weights(q_proj_weight, k_proj_weight, v_proj_weight, o_proj_weight)
...
def run_train_bpe(
    ...
    **kwargs,
    ...
    trainer.train_from_scratch(input_path, process_num=1)

    trainer.print_time_statictics()

    return (trainer.vocab, trainer.history_merges)
